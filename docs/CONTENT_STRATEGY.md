...
Phase 1AG now includes zh-tw/en commuter pass decision articles for topic 8 and links them to the commuter pass / IC card checklist. Phase 1AH includes zh-tw/en residence card, resident record, and My Number articles for topic 13, Phase 1AP extends both topics to ja/ko, Phase 1AR extends the rental initial-cost guide across en/ja/ko, Phase 1AV adds zh-tw/en/ja/ko apartment-viewing practical Japanese articles for topic 15, Phase 1AW adds zh-tw/en/ja/ko ward-office moving-in procedure articles for the administrative setup cluster, Phase 1AX adds zh-tw/en/ja/ko apartment moving-out articles for the rental lifecycle cluster, Phase 1AY adds zh-tw/en/ja/ko garbage sorting articles for daily-life rules, and Phase 1AZ extends the family restaurant comparison to en/ja/ko.
