...
Phase 1AG now includes zh-tw/en commuter pass decision articles for topic 8 and links them to the commuter pass / IC card checklist. Phase 1AH now includes zh-tw/en residence card, resident record, and My Number articles for topic 13 and links them to the ward office moving-in checklist.
