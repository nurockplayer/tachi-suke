...
- `zh-tw` / `en` / `ja` / `ko`: now include work contract basics under the `work` category, linked to first-week setup, residence administration basics, MHLW labor consultation, and Study in Japan part-time work guidance
