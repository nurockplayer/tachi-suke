...
- Published static checklist tools: `moving-to-japan-checklist`, `japan-rent-initial-cost-checklist`, `ward-office-moving-in-checklist`, `commuter-pass-ic-card-checklist`, `apartment-viewing-japanese-phrases`, `apartment-application-documents-checklist`, `moving-out-checklist`, and `japan-emergency-disaster-checklist`.
...
- Tools currently include eight static checklists and phrase tools. Checklist state is not saved and there is no user-specific progress tracking.
...
2. Add more practical tools, starting with job search, everyday shopping, and moving-in neighborhood setup checklists.
