...
- Built representative pages include parseable JSON-LD for site identity, locale homepages, article index pages, article detail pages, place detail pages, mobile plan detail pages, area detail pages, tool detail pages, and breadcrumbs.
