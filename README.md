...
- Build-output SEO check in `tests/seo-output.test.mjs`, including sitemap-derived canonical, `og:url`, title, description, Open Graph, and Twitter metadata sweeps for indexable public HTML pages
