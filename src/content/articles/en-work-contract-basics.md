---
id: "article-en-japan-work-contract-basics"
slug: "japan-work-contract-basics-en"
locale: "en"
translationKey: "japan-work-contract-basics"
title: "Before Working in Japan: Contract and Residence Status Basics"
description: "A practical pre-work checklist for foreign residents in Japan covering residence status, work permission, written conditions, wages, shifts, transport allowance, insurance, and resignation rules."
category: "work"
tags:
  - "working in Japan"
  - "part-time job"
...
This guide is a preparation checklist, not legal advice. It focuses on the questions to ask before you sign or start. If you are still in your first week, read the [first-week setup guide](/en/articles/first-week-japan-setup) and the [residence card, resident record, and My Number guide](/en/articles/residence-card-resident-record-my-number-en) first.
...
International students can start with Study in Japan's [Part-Time Work](https://www.studyinjapan.go.jp/en/work-in-japan/part-time-jobs/) guidance, then confirm their own situation with their school or immigration office.
...
If you cannot read the Japanese document, do not sign just because someone says it is standard. Ask a school office, trusted person, labor consultation counter, or professional to help check it. MHLW's [foreign worker consultation page](https://www.check-roudou.mhlw.go.jp/soudan/foreigner.html) is one official starting point for consultation resources.
...
If you are still choosing where to live, put the workplace into your [area comparison](/en/areas). A long commute can affect sleep, study, health, and renewal plans.
