---
id: "article-en-residence-admin-basics"
slug: "residence-card-resident-record-my-number-en"
locale: "en"
translationKey: "residence-card-resident-record-my-number"
title: "Residence Card, Resident Record, and My Number: What Foreign Residents Should Know"
description: "A practical explanation of the difference between a residence card, resident record, and My Number in Japan, and what to confirm after moving in."
category: "procedures"
tags:
  - "residence card"
  - "resident record"
...
1. Your name and nationality or region.
2. Your residence status and period of stay.
3. The validity period.
4. Whether your address needs to be updated.
5. Whether a job, school, address, or residence-status change creates another notification or procedure.
...
If you have just arrived or moved, start with the [ward office moving-in checklist](/en/tools/ward-office-moving-in-checklist) to prepare documents and questions before visiting the counter.
...
1. Confirm your actual address.
2. Find the ward office, city office, or branch office responsible for that address.
3. Prepare passport, residence card, address details, lease or move-in documents.
4. Ask the office about resident registration, address updates, health insurance, pension, and My Number-related steps.
5. Update confirmed address details with mobile service, bank, school, employer, and other important services.

If you are still arranging your first week, read [First Week in Japan: What to Set Up First](/en/articles/first-week-japan-setup). If your phone setup is not stable, start with the [mobile plan page](/en/mobile), because many banking, school, employer, and administrative flows are easier when you can receive messages reliably.
...
Then open the [ward office moving-in checklist](/en/tools/ward-office-moving-in-checklist), write down the documents and questions you need, and confirm the latest requirements with the relevant office.
