---
id: "article-en-ward-office-moving-in-procedures"
slug: "ward-office-moving-in-procedures-en"
locale: "en"
translationKey: "ward-office-moving-in-procedures"
title: "What to Prepare Before Visiting a Ward or City Office After Moving in Japan"
description: "A practical guide for foreign residents preparing for ward or city office moving-in procedures in Japan, including address registration, residence card updates, health insurance, pension, My Number, and follow-up updates."
category: "procedures"
tags:
  - "ward office"
  - "city office"
...
sourceLinks:
  - label: "Immigration Services Agency: Daily Life Support Portal"
    ...
    note: "Official Japan government guidance for foreign residents, useful before checking municipal moving-in procedures."
  - label: "Digital Agency: My Number FAQ"
    url: "https://www.digital.go.jp/en/policies/mynumber_faq_02"
    note: "Official guidance for My Number notification and resident-registration-related questions; local office rules still apply."
draft: false
---
...
The details vary by municipality, household situation, residence status, and timing. Treat this guide as preparation for the counter, not a universal rulebook. When you are ready to act, use the [ward office moving-in checklist](/en/tools/ward-office-moving-in-checklist) alongside the latest information from your municipality.
...
If you are still organizing your first week, use the [first-week setup guide](/en/articles/first-week-japan-setup). If the difference between a residence card, resident record, and My Number is still unclear, read the [residence administration basics](/en/articles/residence-card-resident-record-my-number-en) first.
...
If your mobile setup is still unfinished, start from the [mobile plan guide](/en/mobile) to review identity checks, payment methods, data needs, and plan caveats.

## Next step

Before going to the office, write down your situation, address details, and questions. At the counter, confirm what can be completed today, what is missing, where to go next, and whether any deadlines apply. Then compare your notes with the [moving-in checklist](/en/tools/ward-office-moving-in-checklist) so follow-up updates do not get lost.
