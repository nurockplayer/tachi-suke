...
describe("TachiSuke project scaffold", () => {
  ...
  it("includes Phase 1B content depth for articles, mobile plans, and area guides", () => {
    ...
    assert.ok(articles.length >= 20, "Phase 1AP should include ja/ko transportation and procedures article coverage");
    ...
    assert.ok(localeCounts.ja >= 4, "Phase 1AP should include at least 4 ja articles");
    assert.ok(localeCounts.ko >= 4, "Phase 1AP should include at least 4 ko articles");
